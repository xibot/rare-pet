...
const scenes = [
  { id: '01-garden-oval-complete', crop: [329, 451, 931, 415], anchor: [344, 168], petAnchor: [372, 280] },
  { id: '02-circuit-courtyard-complete', crop: [225, 421, 1150, 488], anchor: [346, 75], petAnchor: [404, 308] },
  { id: '03-crystal-mesa-complete', crop: [288, 386, 1003, 502], anchor: [286, 262], petAnchor: [356, 268] },
  { id: '04-rooftop-terrace-complete', crop: [163, 404, 1274, 422], anchor: [315, 120], petAnchor: [224, 128] },
  { id: '05-tidal-islands-complete', crop: [381, 451, 942, 390], anchor: [206, 104], petAnchor: [216, 120] },
  { id: '06-orbital-hex-complete', crop: [462, 399, 824, 434], anchor: [224, 82], petAnchor: [412, 152] },
] as const;

export const SPACE_ISLAND_ART = scenes.map(({ id, crop, anchor, petAnchor }) => {
